export default function TermsPage() {
  ...
  return (
    <div className="page" style={{ background: "#ffffff", padding: "40px 0" }}>
      <div className="shell narrow" style={{ maxWidth: "850px", margin: "0 auto", padding: "0 20px" }}>
        
        {/* Header */}
        <header className="page-heading" style={{ marginBottom: "32px" }}>
          <span className="eyebrow" style={{ color: "#666", textTransform: "uppercase", fontSize: "0.85rem", letterSpacing: "1px" }}>
            Heart Mobile Legal Documentation
          </span>
          <h1 style={{ color: primaryBlue, fontSize: "2.2rem", fontWeight: "700", marginTop: "8px", marginBottom: "8px" }}>
            Terms & Conditions
          </h1>
          <p style={{ color: "#555", fontSize: "0.95rem" }}>
            Effective Date: August 2026 | Heart Mobile (101123964 Ontario LTD.)
          </p>
        </header>

        {/* Policy Content */}
        <div className="policy" style={{ display: "flex", flexDirection: "column", gap: "28px" }}>
          
          {/* Quick Summary */}
          <section style={{ background: "#F4F7FA", padding: "20px 24px", borderRadius: "8px", borderLeft: `4px solid ${primaryBlue}` }}>
            <h2 style={{ color: primaryBlue, fontSize: "1.3rem", fontWeight: "700", marginBottom: "12px" }}>
              Quick Summary
            </h2>
            ...
            <p style={{ marginBottom: "10px", lineHeight: "1.6" }}>
              ...
              By using the site you accept these terms; if you disagree you should not use the site.
            </p>
            <p style={{ marginBottom: "0", lineHeight: "1.6" }}>
              <strong style={{ display: "block", color: "#222", marginBottom: "2px" }}>Jurisdiction & Applicable Law</strong>
              Use is intended for Canadian residents and is governed by the laws of the Province of Ontario.
            </p>
          </section>

          {/* Important Notice */}
          <section>
            <h2 style={{ color: primaryBlue, fontSize: "1.3rem", fontWeight: "700", marginBottom: "10px" }}>
              Important Notice
            </h2>
          ...
          <section>
            ...
            <p style={{ lineHeight: "1.6" }}>
              <strong style={{ display: "block", color: sectionBlue, fontSize: "1.05rem", marginBottom: "4px" }}>
                Eligibility, Jurisdiction & Age Requirements
              </strong>
          ...
          <section>
            ...
            <p style={{ marginBottom: "16px", lineHeight: "1.6" }}>
              <strong style={{ display: "block", color: sectionBlue, fontSize: "1.05rem", marginBottom: "4px" }}>
                1. Copyright & Property Protection
              </strong>
            ...
            <p style={{ lineHeight: "1.6" }}>
              <strong style={{ display: "block", color: sectionBlue, fontSize: "1.05rem", marginBottom: "4px" }}>
                2. Copying, Mirroring & Resale Prohibitions
              </strong>
          ...
          <section>
            ...
            <p style={{ marginBottom: "16px", lineHeight: "1.6" }}>
              <strong style={{ display: "block", color: sectionBlue, fontSize: "1.05rem", marginBottom: "4px" }}>
                2. Reservation of Rights & Order Processing
              </strong>
